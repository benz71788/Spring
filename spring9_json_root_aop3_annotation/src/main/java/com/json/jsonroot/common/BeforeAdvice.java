...
//공통으로 처리할 로직을 LogAdvice클래스에서 beforeLog()메서드로 구현합니다.
...
public class BeforeAdvice {
	/*
	 * @Pointcut을 설정합니다.
	 * 하나의 Advice클래스 안에 여러 개의 포인트 컷을 선언할 수 있습니다.
	 ...
	 * 								Advice의 메서드 beforeLog()가 먼저 호출됩니다.
	 */
	//Advice
	@Before("getPointcut()")
	public void beforeLog(JoinPoint proceeding) {
		System.out.println("========>BeforeAdvice : 비즈니스 로직 수행 적 동작입니다.");
		System.out.println("========>" 
